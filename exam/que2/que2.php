...
if (isset($_POST['submitBtn'])) {
    ...
    $post_stu_sql = $conn->prepare("INSERT INTO marks (StudentName,RollNo,mark1,mark2,mark3,mark4,mark5,percentage) VALUES(?,?,?,?,?,?,?,?)");
    $post_stu_sql->bind_param("sddddddd", $name, $roll, $mark1, $mark2, $mark3, $mark4, $mark5, $percentage);
...
<body>
    ...
    <form action="./que2.php" method="post">
        ...
        <input type="number" min="0" max="100" id="mark5" name='mark5'><br>
